            ...
            <?php foreach ($bulletin_board as $bulletin) : ?>
                <li class="lots__item lot">
                    <div class="lot__image">
                        <img src="<?= $bulletin["url_image"]; ?>" width="350" height="260" alt="Сноуборд">
                    </div>
                    <div class="lot__info">
                        <span class="lot__category"><?= $bulletin["category"]; ?></span>
                        <h3 class="lot__title"><a class="text-link" href=""><?= $bulletin["name"]; ?></a></h3>
                        <div class="lot__state">
                            <div class="lot__rate">
                                <span class="lot__amount">Стартовая цена</span>
                                <span class="lot__cost"><?= $bulletin["price"]; ?><b class="rub">р</b></span>
                            </div>
